...
<Columns cols="3">
  ...
  <Card title="Interior Walk" icon="person-walking" href="/features/interior-walk">
  ...
  <Card title="Cabin Mode" icon="door-open" href="/features/cabin-mode">
    Dedicated cockpit↔cabin workflow — single action to leave the seat, walk the interior, and return to cockpit.
  </Card>
  ...
  <Card title="Rotor Kill Zone" icon="skull">
    Spinning rotor blades are lethal. Players entering the disc radius take fatal damage. Seated crew, cabin walkers, and grab-hold passengers are automatically exempted.
  </Card>
...
<Tip>
  Cargo seats have their own seat-exit walk behaviour — passengers can stand up while airborne and remain linked to the aircraft until they choose to disembark.
</Tip>
