...
- **Cabin Mode (Interior Walk)** — pilot or co-pilot of the UH-1H and Blackhawk look back and use the **Move to Cabin** action to leave their cockpit seat and walk freely inside the cabin with full movement and weapon use; at any time they can use **Return to Cockpit** to return to their seat
