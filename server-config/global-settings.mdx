...
<Tip>
  **We strongly recommend enabling activity logging on all servers.** It has no meaningful performance impact and gives you the evidence you need to handle compensation requests, combat log reports, theft disputes, and any other helicopter-related situation fairly and accurately. Without it, you are relying entirely on player accounts of what happened.
</Tip>
